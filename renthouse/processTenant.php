...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$sql="insert into `check`(`Fare`,`Date`,`HouseID`,`TenantTel`) values('$Fare','$watchDate','$houseId','$tenantTel');";
if(mysqli_query($conn,$sql)==TRUE){
	echo '<script type="text/javascript">
	alert("预约看房信息提交成功，等待房主确认");
